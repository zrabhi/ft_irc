...
SRC = ./src/main.cpp ./src/server/server.cpp ./src/Commands/NICK.cpp ./src/Commands/USER.cpp ./src/Commands/PASS.cpp \
		./src/Commands/PRIVMSG.cpp ./src/Commands/JOIN.cpp ./src/Commands/PART.cpp ./src/Commands/KICK.cpp ./src/Commands/NOTICE.cpp ./src/Commands/Commands.cpp ./src/client/client.cpp ./src/Channel/channel.cpp 
